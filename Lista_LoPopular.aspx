<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Lista_LoPopular.aspx.vb" Inherits="PLWeb5_0.Lista_LoPopular" %>
...
//            ValidarDatos();
        ...
        function IraListaPopulares() {
            window.location.href = "Populares.aspx?Pag=1";
        }
...
<body>
    ...
    <div>
        <table id="Table1" style="height:100px">
            ...
            <tr>
                <td>
                    <input id="btnVerMas" type="button" value="Ver Mas..."  onclick="IraListaPopulares()" onmouseover="this.style.cursor='pointer'" class="link_btn_round_md sv_votar"  />
                </td>
            </tr>
        </table>    
    </div>
